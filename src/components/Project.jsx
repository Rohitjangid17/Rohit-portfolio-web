            ...
            <section className='py-10 bg-white px-5 sm:px-0'>
                <div className='container mx-auto'>
                    <div className='flex flex-col gap-y-1'>
                        <h2 className='text-[#757575] text-sm sm:text-base'>MY WORK</h2>
                        <h2 className='text-[#f26200] text-[34px] sm:text-[44px] font-semibold'>Projects</h2>
                            ...
                            <div key={project.id} className="cursor-pointer w-full bg-white rounded-lg shadow-lg overflow-hidden transform transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-2xl card-entrance">
                                <div className="relative">
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 p-4 flex items-center justify-between">
                                        <h2 className="text-white text-xl font-semibold text-shadow-md">{project.name}</h2>
