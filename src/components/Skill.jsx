            ...
            <section className='py-10 bg-white px-5 sm:px-0'>
                <div className='container mx-auto'>
                    <div className='flex flex-col gap-y-1'>
                        <h2 className='text-[#757575] text-sm sm:text-base'>TECHNOLOGIES USED</h2>
                        <h2 className='text-[#f26200] text-[34px] sm:text-[44px] font-semibold'>Skills</h2>
                    ...
                    <div className='grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-7 gap-x-5 gap-y-10 mt-10'>
                        {skills.map((skill) => (
                            <div key={skill.id} className="cursor-pointer w-full flex flex-col gap-y-4">
                                ...
                                <h2 className="text-[#f26200] text-base sm:text-lg font-semibold tracking-wide text-center">{skill.title}</h2>
                            </div>
