            ...
            <section className='h-[90vh] bg-[#f5ecdb]'>
                <div className='container mx-auto h-full'>
                    <div className='flex flex-col h-full justify-center items-center gap-y-[22px] px-5'>
                        ...
                        <p className='text-center font-normal text-[#757575] text-lg'>Welcome to my digital playground, where pixels and code collide. I'm a frontend developer, crafting interactive marvels from visions. With creativity and tech savvy, I design captivating interfaces. Dive into my portfolio for the ultimate fusion of design and development.</p>
